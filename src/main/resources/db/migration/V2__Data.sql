...
INSERT INTO translation_statuses (name) VALUES
('Не начат'),
('В процессе'),
('Завершен');
...
BEGIN
    ...
    FOR i IN 1..40 LOOP
        ...
        INSERT INTO comics (
            ...
            release_year, translation_status_id, comic_status_id,
...
-- Секции пользователей + сохранённые
...
-- случайные связи между комиксами
DO $$
DECLARE
    a INT;
    b INT;
