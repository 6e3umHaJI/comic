...
<div class="filters-wrapper">
    ...
    <div class="filter-group">
      ...
      <div class="filter-options">
        <c:forEach items="${types}" var="t">
          <label>
            <input class="check-ui" type="checkbox" name="selectedTypes" value="${t.name}"
    ...
    <div class="filter-group">
      ...
      <div class="filter-options">
        <c:forEach items="${statuses}" var="s">
          <label>
            <input class="check-ui" type="checkbox" name="selectedComicStatuses" value="${s.name}"
    ...
    <div class="filter-group">
      ...
      <div class="filter-options">
        <c:forEach items="${ageRatings}" var="ar">
          <label>
            <input class="check-ui" type="checkbox" name="selectedAgeRatings" value="${ar.name}"
  ...
  <div class="filter-group collapsible">
    ...
    <div class="filter-options scrollable">
      <c:forEach items="${genres}" var="g">
        <label>
          <input class="check-ui" type="checkbox" name="selectedGenres" value="${g.name}"
    ...
    <label class="switch-toggle">
      <input class="check-ui" type="checkbox" name="strictGenreMatch"
  ...
  <div class="filter-group collapsible">
    ...
    <div class="filter-options scrollable">
      <c:forEach items="${tags}" var="t">
        <label>
          <input class="check-ui" type="checkbox" name="selectedTags" value="${t.name}"
    ...
    <label class="switch-toggle">
      <input class="check-ui" type="checkbox" name="strictTagMatch"
  ...
  <div class="filter-group collapsible">
      ...
      <label class="switch-toggle">
          <input type="checkbox" name="strictLanguageMatch" ${searchCriteria.strictLanguageMatch ? 'checked' : ''}>
